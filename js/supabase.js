 ...
 */
(function () {
  var SUPABASE_URL = 'https://ljemymboaebiimfsltqk.supabase.co';  // F.eks. 'https://xxxxx.supabase.co'
  var SUPABASE_ANON_KEY = 'sb_publishable_E76ZOEKS53qllEHTlO-CoQ_I-s-qyrN';  // Public anon key (ikke service_role)
